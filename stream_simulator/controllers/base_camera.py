...
class BaseCameraController(BaseThing):
    """
    ...
    Methods:
        ...
        (mock or simulation).
    """
    def __init__(self, conf = None, package = None, host = None):
        ...
        super().set_conf(conf) # This is needed for the base class / Env camera
        ...
        if self.host == "robot":
            ...
            if 'host' in info['conf']:
                tf_package['host'] = info['conf']['host']
                tf_package['host_type'] = 'pan_tilt'
