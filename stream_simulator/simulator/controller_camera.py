...
class CameraController:
    def __init__(self, name = "robot", logger = None):
        ...
        self.get_image_rpc_server = RPCServer(conn_params=ConnParams.get(), on_request=self.get_image_callback, rpc_name=name + ":camera:get_image")

    def start(self):
        self.get_image_rpc_server.run()
        self.logger.info("Robot {}: get_image_rpc_server started".format(self.name))
