...
class TouchScreenController:
    def __init__(self, info = None):
        ...
        self.show_image_rpc_server = RPCService(conn_params=ConnParams.get("redis"), on_request=self.show_image_callback, rpc_name=info["base_topic"] + "/show_image")
        self.logger.info("Created redis RPCService {}".format(
            info["base_topic"] + "/show_image"
        ))
